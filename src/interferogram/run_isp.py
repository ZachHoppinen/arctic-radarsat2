...
def gamma_radarsat2_interferogram(dir1: Path, dir2: Path, meta: pd.DataFrame, dems: dict, test_dir: Path):
    """
    Take 2 directories with radarsat2 datasets and coregister and generate interferograms

    Args:
    dir1 [Path]: SLC directory 1
    dir2 [Path]: SLC directory 2
    meta [Pandas Dataframe]: Dataframe of image AOI names, acquisition dates
    dems [Dict]: list of dem files
    test_dir: directory to generate out files
